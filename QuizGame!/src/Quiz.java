...
public class Quiz implements ActionListener {
	...
	String[] question = {
			...
			"How are you?", "Are you ok?", "Are you sure?", "Whos This?" };

	String[][] options = {

			{ "Good", "Bad", "Nice", "Low" }, { "No", "Yes", "Maybe", "I love cookies" },
			{ "Not Sure", "Im A Little Warm", "I am Hungry", "I could eat something" },
			{ "Kordian", "Alex", "Zac", "Sean" }
